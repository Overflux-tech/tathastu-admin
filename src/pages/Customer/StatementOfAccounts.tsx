...
const FISCAL_YEARS = [
  { label: "FY 2025-2026", start: "2025-04-01", end: "2026-03-31" },
  { label: "FY 2024-2025", start: "2024-04-01", end: "2025-03-31" },
  { label: "FY 2023-2024", start: "2023-04-01", end: "2024-03-31" },
];
...
export default function StatementOfAccounts() {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      const opt = {
        margin: 0,
        filename: `statement-${customerName.replace(/\s+/g, "-")}-${currentDate}.pdf`,
  ...
  const fiscalYearOptions = FISCAL_YEARS.map((y) => ({
    value: y.label, // IMPORTANT: value = label
    label: y.label,
  }));
            ...
            <div className="text-right" data-html2canvas-ignore="true">
              <div className="flex justify-end gap-3 mb-4 no-print">
                <Select
                  ...
                  onChange={(value) => {
                    const year = FISCAL_YEARS.find((y) => y.label === value);
